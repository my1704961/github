                        ...
                        <div class="col">
                            ...
                            <div class="product_grid">
                                ...
                                <c:forEach items="${categories}" var="c">
                                    <div class="product">
                                        <div class="product_image"><img src="<c:url value='/resources/img/logo/${c.namePicture}' />"/></div>

                                        <div class="product_content">
                                            <div class="product_title" style="text-align: center;"><a href="${pageContext.request.contextPath}/listProduct/${c.name}">${c.name}</a></div>
                                        </div>
                                    </div>
                                </c:forEach>
                            </div>
